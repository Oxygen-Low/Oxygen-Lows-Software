...
**Vulnerability:** Hardcoded Supabase URL and keys found in codebase.
**Learning:** Hardcoding sensitive values in code exposes them to anyone with access to the source code.
**Prevention:** Use environment variables (`process.env` or `import.meta.env`) instead of hardcoding sensitive data.
