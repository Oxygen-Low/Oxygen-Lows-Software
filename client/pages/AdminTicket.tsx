...
export default function AdminTicket() {
  ...
  usePageTitle(
      ...
      : t("titles.adminTicket", undefined, "Admin Support Ticket"),
    {
      description:
        ticket?.description ||
        t("admin.supportDesc", undefined, "Manage user support tickets."),
    },
  );
                ...
                <Input
                  placeholder={
                    ticket.status === "Closed"
                      ? t(
                          "supportTicket.ticketClosed",
                          undefined,
                          "Ticket is closed",
                        )
                      : t(
                          "supportTicket.writeReply",
                          undefined,
                          "Type your reply...",
                        )
                  }
