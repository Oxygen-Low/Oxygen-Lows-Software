export const en = {
  ...
  digitalFootprint: {
    ...
    tabScanner: "Scanner",
    tabRedact: "Social Redact",
    tabOptOut: "Opt-Out Guide",
    enterAtLeastOne: "Please enter at least one identifier to scan.",
    scanCompleted: "Footprint scan completed successfully!",
    exportAudit: "Export Audit",
    reportExported: "Audit report exported as JSON.",
    inputDetails: "Target Identifiers",
    inputDescription:
      "Provide any handles, emails, or credentials you wish to scan locally.",
    username: "Username / Handle",
    email: "Email Address",
    phone: "Phone Number",
    passwordCheck: "Password (k-Anonymity Leak Check)",
    kAnonymityNote:
      "Hashed with SHA-1. Only 5 hex characters are queried; password never leaves your browser.",
    realName: "Real Name / Alias",
    startScan: "Run Footprint Scan",
    scanning: "Scanning...",
    readyToScan: "Ready to Scan Digital Footprint",
    readyDescription:
    ...
    loadSample: "Load Sample Test Query",
    runningScan: "Performing Deep Reconnaissance...",
    queryingLocal:
      "Querying 30+ service endpoints, k-anonymity breach databases, and broker directories.",
    privacyScore: "Privacy Score",
    risk: "Risk",
    publicProfiles: "Mapped Endpoints",
    acrossServices: "Across social & developer services",
    breachesDetected: "Breaches & Dumps",
    historicalExposures: "Historical breach catalogs matched",
    threatAlerts: "Security & Privacy Alerts",
    recommendation: "Action",
    mappedAccounts: "Public Platform Footprint",
    mappedAccountsDesc:
      "Direct profile URLs mapped to this handle. Verify and clean unneeded accounts.",
    matchedBreaches: "Known Historical Breach Exposures",
    desktopExclusiveNotice: "Desktop Exclusive Feature",
    ...
    sessionAuth: "Session Authentication & Content Loader",
    sessionAuthDesc:
      "Credentials are kept strictly in local memory and are never uploaded.",
    sessionTokenOrCookie: "Session Token / API Key / Auth Cookie",
    loadAccountData: "Fetch & List Account Content",
    disconnect: "Disconnect",
    demoSessionLoaded: "Connected to session in local mode.",
    platformConnected: "Authenticated session connected locally.",
    filterOptions: "Redact Filters",
    matchingItems: "matching items",
    keyword: "Keyword / Search",
    startDate: "After Date",
    endDate: "Before Date",
    throttleDelay: "Request Delay (Rate Limiting)",
    selectAll: "Select All Visible",
    downloadArchive: "Export Backup JSON",
    massDelete: "Mass Delete Selected",
    deletingItems: "Wiping items...",
    deletionFinished: "Deletion Finished",
    noItemsMatch: "No items found matching the current filters.",
    noItemsSelected: "No items selected.",
    backupExported: "Backup archive exported successfully!",
    massDeleteComplete: "Successfully wiped items!",
    dataBrokerDirectory: "Data Broker Opt-Out Directory",
    dataBrokerDirectoryDesc:
      "Direct links to opt-out forms of major commercial people-search brokers.",
    optOutLink: "Submit Opt-Out",
    privacyHardening: "Privacy Hardening Checklist",
    privacyHardeningDesc:
      "Practical actions you can take today to minimize your digital footprint.",
    confirmDeleteTitle: "Confirm Mass Content Deletion",
    confirmDeleteDesc:
    ...
    wipeNow: "Proceed with Mass Wipe",
  },
  titles: {
    apps: "Apps",
    games: "Games",
