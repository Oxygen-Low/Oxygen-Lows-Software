export const en = {
  ...
  support: {
    ...
    typeRequest: "Request",
    typePartnerRequest: "Partner Request",
  ...
  admin: {
    ...
    partnersTitle: "Partners Management",
    partnersSubtitle:
      "Manage active partners and target partner categories displayed on the public Partners page.",
    viewPublicPage: "View Public Page",
    tabExisting: "Existing Partners",
    tabWanted: "Wanted Categories",
    existingPartnersTitle: "Active Partners",
    existingPartnersDesc:
      "Companies and organizations currently partnered with Oxygen Low's Software.",
    addPartner: "Add Partner",
    addFirstPartner: "Add First Partner",
    noExistingPartners: "No existing partners added yet.",
    wantedPartnersTitle: "Wanted Partner Categories & Requests",
    wantedPartnersDesc:
      "Define target partnership opportunities, what Oxygen Low's Software provides, and what is requested.",
    addWantedCategory: "Add Category Opportunity",
    addFirstWanted: "Add First Opportunity",
    noWantedPartners: "No wanted partner opportunities defined yet.",
    ...
    partnerCategory: "Category / Industry",
    partnerLogoUrl: "Logo URL",
    partnerWebsiteUrl: "Website URL",
    partnerDescription: "Description",
    partnerCreated: "Partner added successfully",
    partnerUpdated: "Partner updated successfully",
    deletePartnerConfirm: "Are you sure you want to delete partner \"{{name}}\"?",
    partnerDeleted: "Partner deleted successfully",
    addWantedTitle: "Add Wanted Partner Opportunity",
    editWantedTitle: "Edit Wanted Partner Opportunity",
    wantedModalDesc:
      "Define the category, targets, and mutual value exchange for prospective partners.",
    wantedCategoryField: "Category Name",
    wantedTargetCompaniesField: "Target / Example Companies",
    wantedCreated: "Opportunity added successfully",
    wantedUpdated: "Opportunity updated successfully",
    deleteWantedConfirm: "Are you sure you want to delete category \"{{category}}\"?",
    wantedDeleted: "Opportunity deleted successfully",
  },
  partners: {
    title: "Oxygen Low's Software Partners",
    subtitle:
      "Explore existing partners and collaboration opportunities with Oxygen Low's Software.",
    heroBadge: "Partnerships & Collaborations",
    heroDesc:
    ...
    copyEmailButton: "Copy Email (partner@oxygenlow.com)",
    copied: "Copied!",
    emailCopiedTitle: "Email Copied",
    emailCopiedDesc: "Copied {{email}} to clipboard.",
    emailCopyFailed: "Failed to copy email to clipboard.",
    goToSupportButton: "Request Partnership (Support)",
    viewWantedButton: "View Wanted Partner Opportunities",
    wantedModalTitle: "Wanted Partner Categories & Opportunities",
    wantedModalDesc:
      "Categories and companies Oxygen Low's Software is actively seeking to partner with, including mutual offerings.",
    noWantedYet: "No specific wanted partner categories listed at the moment.",
    targetCompanies: "Target/Example",
    whatWeProvide: "What Oxygen Low's Software Provides",
    whatIsRequested: "What Is Requested from Partner",
    notSpecified: "Flexible integration options.",
    interestedTitle: "Fit one of these categories or have a proposal?",
    interestedDesc: "Contact our partnership team directly.",
    openTicket: "Submit Ticket",
    existingTitle: "Our Partners",
    existingSubtitle:
      "Trusted organizations and companies collaborating with Oxygen Low's Software.",
    noPartnersYetTitle: "Be Our First Partner",
    noPartnersYetDesc:
      "We are currently reviewing applications and expanding our partner network. Reach out to collaborate with us!",
    applyNow: "Apply to Partner",
  ...
  titles: {
    ...
    partners: "Partners",
    admin: "Admin Panel",
    adminPartners: "Admin Partners Management",
  ...
  workspaces: {
    title: "Workspaces",
    subtitle: "Collaborative project spaces to share, write, edit, and discuss files with invited team members.",
    joinWithCode: "Join with Code",
    newWorkspace: "New Workspace",
    searchWorkspaces: "Search workspaces...",
    loading: "Loading workspaces...",
    noMatchingWorkspaces: "No workspaces matching your search.",
    noWorkspacesYet: "You have not joined any workspaces yet.",
    emptyDescription: "Create a project workspace or join an existing one using an invite code or link from a collaborator.",
    createFirstWorkspace: "Create Workspace",
    createWorkspace: "Create New Workspace",
    createWorkspaceDesc: "Create a collaborative space for your team to share storage files, edit code, and discuss tasks.",
    workspaceNameLabel: "Workspace Name *",
    workspaceDescLabel: "Description (optional)",
    createButton: "Create",
    joinTitle: "Join Workspace",
    joinDesc: "Enter the invite code or token shared with you by the workspace owner.",
    ...
    discussionTab: "Team Discussion & Activity",
    searchFiles: "Search project files...",
    addFiles: "Add Files",
    loadingFiles: "Loading files...",
    noMatchingFiles: "No files matching your search",
    noFilesYet: "No files in this workspace yet",
    addFilesPrompt: "Import files from your personal storage or upload fresh assets to collaborate with your team.",
    fileName: "Name",
    fileSize: "Size",
    updated: "Updated",
    author: "By",
    ...
    discussionBoard: "Team Discussion",
    messages: "messages",
    noDiscussionYet: "No messages yet. Start the conversation with your team!",
    typeDiscussion: "Share an update or comment...",
    activityFeed: "Project Activity",
    noActivities: "No recent project activities",
    addFilesToProject: "Add Files to Project",
    addFilesDesc: "Import files copied from your encrypted personal storage, or upload directly from your device.",
    importFromStorage: "Import from My Storage",
    uploadFromDevice: "Upload from Device",
    loadingStorage: "Loading your personal files...",
    noPersonalFiles: "No personal storage files found.",
    filesSelected: "file(s) selected",
    copyIntoWorkspace: "Copy into Workspace",
    uploadingFiles: "Uploading files...",
    dropFilesPrompt: "Click to choose files from device",
    uploadQuotaNote: "Counts against workspace owner quota",
    edit: "Edit",
    preview: "Preview",
    save: "Save",
    loadingEditor: "Loading file content...",
    editorPlaceholder: "Enter file content here...",
    conflictTitle: "Editing Conflict Detected",
    conflictDesc: "Another collaborator saved changes to this file while you were editing. Would you like to overwrite their changes, or discard your unsaved edits?",
    reloadLatest: "Reload Latest",
    overwriteAnyway: "Overwrite Anyway",
    commentsFor: "Comments for",
    noFileCommentsYet: "No comments on this file yet. Leave feedback for collaborators.",
    addFileComment: "Write a comment...",
    projectMembers: "Project Members",
    membersDesc: "Collaborators can view, modify, and discuss project files.",
    remove: "Remove",
    regenerateInvite: "Reset Invite Code",
    confirmDeleteTitle: "Delete Workspace?",
    confirmDeleteDesc: "This permanently deletes all files, comments, and members inside this project workspace. This action cannot be undone.",
    confirmLeaveTitle: "Leave Workspace?",
    confirmLeaveDesc: "You will lose access to the files and discussions in this workspace unless re-invited.",
    leave: "Leave",
    errorLoading: "Failed to load workspace data",
    alreadyMemberToast: "Opened your workspace",
    joinSuccessToast: "Successfully joined workspace!",
    createdSuccess: "Workspace created successfully!",
    inviteCopied: "Invite link copied to clipboard!",
    inviteRegenerated: "Generated new invite code!",
    deletedSuccess: "Workspace deleted.",
    leftSuccess: "Left workspace.",
    memberRemoved: "Member removed from workspace.",
    importedCount: "Imported {count} file(s) into workspace.",
    fileSaved: "File saved successfully!",
    fileDeleted: "File deleted from workspace.",
  ...
  browserApp: {
    ...
    homeSearchPlaceholder: "Search websites or enter URL (e.g. oxygenlow.com)...",
    search: "Search",
    readerMode: "Reader Mode",
    liveMode: "Live Web View",
    ...
    indexedPagesFound: "Found {count} indexed pages",
    noResultsFound: "No indexed pages found for this query.",
    noResultsTip: "Try another keyword, or enter a direct website address.",
    directNavigate: "Navigate directly to",
    webSearchExternal: "Search external web for",
    quickAccess: "Quick Access",
    noBookmarks: "No bookmarks saved yet. Click the bookmark icon in the address bar to bookmark pages!",
    noHistory: "Browsing history is empty.",
    ...
    failedReader: "Unable to extract reader view for this page",
    failedSearch: "Failed to fetch search results",
  },
} as const;
