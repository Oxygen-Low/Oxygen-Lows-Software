export const es = {
  ...
  apps: {
    ...
    digitalFootprintTitle: "Huella Digital",
    digitalFootprintDesc:
      "Audita tu exposición pública, busca credenciales filtradas y limpia el historial de redes sociales localmente.",
  },
  games: {
    title: "Juegos",
    subtitle:
  ...
  digitalFootprint: {
    ...
    subtitle:
      "Audita tu huella digital pública, comprueba credenciales expuestas en bases de datos de filtraciones y limpia el historial de redes sociales sin enviar ningún dato al servidor.",
    tabScanner: "Escáner",
    tabRedact: "Limpieza Social",
    tabOptOut: "Guía de Exclusión",
    enterAtLeastOne: "Introduce al menos un identificador para escanear.",
    scanCompleted: "¡Escaneo de huella digital completado con éxito!",
    exportAudit: "Exportar Auditoría",
    reportExported: "Informe de auditoría exportado en JSON.",
    inputDetails: "Identificadores Objetivo",
    inputDescription:
      "Introduce nombres de usuario, correos electrónicos o credenciales para escanear localmente.",
    username: "Usuario / Alias",
    email: "Correo Electrónico",
    phone: "Número de Teléfono",
    passwordCheck: "Contraseña (Comprobación de Filtración k-Anonymity)",
    kAnonymityNote:
      "Hasheado con SHA-1. Solo se consultan 5 caracteres hexadecimales; la contraseña nunca sale de tu navegador.",
    realName: "Nombre Real / Alias",
    startScan: "Ejecutar Escaneo de Huella",
    scanning: "Escaneando...",
    readyToScan: "Listo para Escanear Huella Digital",
    readyDescription:
      "Introduce un usuario, correo, teléfono o contraseña a la izquierda para descubrir cuentas públicas, filtraciones y riesgos de intermediarios de datos.",
    loadSample: "Cargar Consulta de Prueba",
    runningScan: "Realizando Reconocimiento Profundo...",
    queryingLocal:
      "Consultando más de 30 plataformas, bases de datos k-anonymity y directorios de intermediarios.",
    privacyScore: "Puntuación de Privacidad",
    risk: "Riesgo",
    publicProfiles: "Puntos de Contacto Mapeados",
    acrossServices: "En plataformas sociales y de desarrollo",
    breachesDetected: "Filtraciones Detectadas",
    historicalExposures: "Catálogos históricos de filtraciones coincidentes",
    threatAlerts: "Alertas de Seguridad y Privacidad",
    recommendation: "Acción",
    mappedAccounts: "Huella en Plataformas Públicas",
    mappedAccountsDesc:
      "URLs directas de perfiles mapeadas a este alias. Verifica y elimina cuentas innecesarias.",
    matchedBreaches: "Exposiciones en Filtraciones Históricas",
    desktopExclusiveNotice: "Función Exclusiva de Escritorio",
    desktopExclusiveDesc:
      "La eliminación masiva directa requiere la aplicación de escritorio de Oxygen Low para eludir las restricciones CORS del navegador sin enviar datos a ningún servidor. Puedes previsualizar, filtrar y exportar datos abajo en modo simulación.",
    selectPlatform: "Seleccionar Plataforma",
    sessionAuth: "Autenticación de Sesión y Carga de Contenido",
    sessionAuthDesc:
      "Las credenciales se conservan estrictamente en la memoria local y nunca se cargan.",
    sessionTokenOrCookie: "Token de Sesión / Clave API / Cookie de Autenticación",
    loadAccountData: "Obtener y Listar Contenido",
    disconnect: "Desconectar",
    demoSessionLoaded: "Sesión conectada en modo local.",
    platformConnected: "Sesión autenticada conectada localmente.",
    filterOptions: "Filtros de Redacción",
    matchingItems: "elementos coincidentes",
    keyword: "Palabra Clave / Búsqueda",
    startDate: "Fecha Posterior",
    endDate: "Fecha Anterior",
    throttleDelay: "Retardo de Solicitud (Límite de Frecuencia)",
    selectAll: "Seleccionar Todos los Visibles",
    downloadArchive: "Exportar Copia de Seguridad JSON",
    massDelete: "Eliminar Masivamente Seleccionados",
    deletingItems: "Eliminando elementos...",
    deletionFinished: "Eliminación Finalizada",
    noItemsMatch: "No se encontraron elementos que coincidan con los filtros actuales.",
    noItemsSelected: "Ningún elemento seleccionado.",
    backupExported: "¡Copia de seguridad exportada con éxito!",
    massDeleteComplete: "¡Elementos eliminados con éxito!",
    dataBrokerDirectory: "Directorio de Exclusión de Intermediarios de Datos",
    dataBrokerDirectoryDesc:
      "Enlaces directos a formularios de exclusión de los principales intermediarios comerciales.",
    optOutLink: "Enviar Solicitud de Exclusión",
    privacyHardening: "Lista de Verificación de Privacidad",
    privacyHardeningDesc:
      "Acciones prácticas que puedes realizar hoy para minimizar tu huella digital.",
    confirmDeleteTitle: "Confirmar Eliminación Masiva",
    confirmDeleteDesc:
      "Estás a punto de eliminar permanentemente los elementos seleccionados de",
    cannotBeUndone:
      "Esta acción se realiza del lado del cliente y no se puede deshacer. Recomendamos descargar una copia de seguridad primero.",
    wipeNow: "Proceder con la Eliminación Masiva",
  },
  titles: {
    apps: "Aplicaciones",
    games: "Juegos",
