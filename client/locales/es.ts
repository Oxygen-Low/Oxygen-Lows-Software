export const es = {
  ...
  auth: {
    ...
    signInPasskey: "Iniciar sesión con clave de acceso (Passkey)",
    passkeyNotSupported: "Las claves de acceso no son compatibles con este navegador o dispositivo.",
    passkeySignInFailed: "Error al iniciar sesión con clave de acceso. Inténtelo de nuevo o use su contraseña.",
  },
  migration: {
  ...
  account: {
    ...
    noAuthorizedApps: "No has autorizado ninguna aplicación de terceros.",
    revokeAccess: "Revocar Acceso",
    revokeConfirm:
      "¿Estás seguro de que deseas revocar el acceso a esta aplicación?",
    ...
    providerNotConfiguredWarning:
      "Nota: Este proveedor no tiene una clave API activa configurada. Puedes registrar el modelo ahora y configurar las credenciales más tarde.",
  },
  userProfile: {
  ...
  apps: {
    ...
    workspacesDesc:
      "Espacios de proyectos colaborativos para compartir, escribir, editar y debatir archivos con miembros invitados.",
    ...
    developerAuthTitle: "Autenticación para Desarrolladores",
    developerAuthDesc:
    ...
    webDefenderAbuseDesc: "Comprueba las IP bloqueadas con AbuseIPDB y añade automáticamente las IP abusivas confirmadas a la lista de bloqueo de esta aplicación.",
    ...
    webDefenderOutboundMonitoringDesc:
      "Rastree y registre las conexiones de red HTTP/HTTPS salientes realizadas por su aplicación. Cuando está deshabilitado, la interceptación de red se desactiva.",
    ...
    webDefenderXssDesc:
      "Detecte y bloquee etiquetas de script, controladores de eventos en línea y vectores de inyección de javascript.",
    webDefenderNosql: "Inyección NoSQL",
    webDefenderNosqlDesc:
      "Prevenga la inyección de operadores de MongoDB y los ataques de manipulación de parámetros.",
    webDefenderProtoPollution: "Contaminación de prototipos",
    webDefenderProtoPollutionDesc:
      "Bloquee los intentos de manipulación del prototipo de objeto (__proto__, constructor.prototype).",
    webDefenderAllowlistIps: "Lista de IP permitidas (IP de confianza)",
    webDefenderAllowlistIpsDesc:
      "Direcciones IP de confianza o subredes CIDR que eluden todas las protecciones WAF, la detección de bots y los límites de tasa.",
  ...
  gameLibrary: {
    ...
    supportedGamesBadge: "Sincronización activada",
    supportedGamesTitle: "Directorio de juegos compatibles",
    supportedGamesSubtitle: "Sincronización en la nube, empaquetado de mods y resolución de rutas en títulos reconocidos.",
    supportedGamesDescription: "Oxygen Low's Software resuelve automáticamente los directorios de instalación y datos para los títulos compatibles. Configura los interruptores de sincronización independientes y las rutas personalizadas a continuación.",
    globalSyncSwitches: "Interruptores globales de sincronización",
    enableAll: "Activar todo",
    disableAll: "Desactivar todo",
    syncAllNow: "Sincronizar todo ahora",
    syncingAll: "Sincronizando todos los juegos...",
    allGamesUpToDate: "Todos los juegos están actualizados",
    ...
    statusSyncError: "Error de sincronización",
    statusIdle: "Al día",

    customPathsTitle: "Configuración de rutas",
    customPathsDesc: "Invalida las rutas automáticas si este juego o sus partidas guardadas están en ubicaciones no estándar.",
    customInstallPath: "Directorio de instalación personalizado",
    customSavePath: "Directorio de partidas guardadas personalizado",
    customModsPath: "Directorio de mods personalizado",
    customConfigPath: "Directorio de configuración personalizado",
    ...
    pathSecurityWarning: "El desplazamiento de rutas fuera de los directorios permitidos está bloqueado por seguridad.",
    customModDlcProtected: "Los archivos de expansión oficial están protegidos y no se pueden empaquetar como mods personalizados.",

    categoryData: "Datos del juego",
    categoryDataDesc: "Partidas de campaña, progresión, desbloqueos y archivos de configuración",
    categorySaves: "Partidas guardadas",
    categorySavesDesc: "Archivos de guardado del jugador y estados de progresión de campaña",
    categoryModLists: "Listas de mods",
    categoryModListsDesc: "Configuraciones de mods activas y orden de carga (la sincronización automática expira en 24 h)",
    ...
    categoryIdeologies: "Ideologías",
    categoryIdeologiesDesc: "Ideologías y estructuras de creencias personalizadas creadas por el jugador",
    categoryXenotypes: "Xenotipos",
    categoryXenotypesDesc: "Xenotipos genéticos personalizados y genomas diseñados por el jugador",
    categorySubmarines: "Submarinos personalizados",
    categorySubmarinesDesc: "Planos de submarinos personalizados, diseños de lanzaderas y especificaciones de cascos",
    ...
    savesAndModsTitle: "Sincronización en la nube de partidas y mods",
    ...
    lastSyncedTime: "Última sincronización: {time}",
    neverSynced: "Nunca sincronizado",
    syncProgress: "Progreso de sincronización: {percent}%",
    ...
    stageUploading: "Subiendo instantánea a la nube...",
    stageDownloading: "Descargando instantánea de la nube...",

    conflictAlertTitle: "Sincronización pausada: conflicto detectado",
    conflictAlertDesc: "Los archivos locales y el almacenamiento en la nube tienen cambios divergentes. Resuelve este conflicto para reanudar la sincronización.",
    resolveConflict: "Resolver conflicto",

    snapshotsTitle: "Instantáneas y copias de seguridad",
    snapshotsSubtitle: "Explora partidas en un punto en el tiempo y copias de seguridad de listas de mods.",
    takeSnapshot: "Tomar instantánea",
    createSnapshot: "Crear instantánea",
    snapshotNamePlaceholder: "Nombre de la instantánea (p. ej., Antes del jefe)...",
    creatingSnapshot: "Creando instantánea...",
    noSnapshots: "No se encontraron instantáneas para este juego",
    noSnapshotsDesc: "Crea una instantánea manual arriba o activa la sincronización de categorías para generar copias en la nube.",
    filterByCategory: "Filtrar por categoría",
    allCategories: "Todas las categorías",

    retentionAutoSync: "Sincronización automática 24 h",
    ...
    retentionNotice: "Las listas de mods sincronizadas automáticamente caducan a las 24 horas. Fija una instantánea para conservarla permanentemente.",

    restoreSnapshot: "Restaurar",
    restoring: "Restaurando...",
    restoreConfirmTitle: "¿Restaurar instantánea?",
    restoreConfirmDesc: "La restauración reemplazará tus archivos locales actuales con el contenido de esta instantánea. Esto no se puede deshacer.",
    deleteSnapshot: "Eliminar",
    deleting: "Eliminando...",
    deleteConfirmTitle: "¿Eliminar instantánea?",
    deleteConfirmDesc: "¿Seguro que deseas eliminar permanentemente esta instantánea del almacenamiento en la nube?",
    ...
    conflictModalTitle: "Conflicto de sincronización en la nube",
    conflictModalSubtitle: "Cambios divergentes detectados en {game} ({category})",
    conflictModalDesc: "Se realizaron modificaciones tanto localmente en este equipo como en la nube. Selecciona cómo deseas resolver este conflicto para reanudar la sincronización.",
    localVersionTitle: "Versión local (Esta computadora)",
    localVersionDesc: "Archivos actualmente presentes en el directorio local de tu juego.",
    cloudVersionTitle: "Versión en la nube (Nube de Oxygen Low's Software)",
    cloudVersionDesc: "Instantánea almacenada en la cuenta de Oxygen Low's Software.",
    ...
    diffNewer: "Más reciente",
    diffOlder: "Más antiguo",
    diffLarger: "Más grande",
    diffSmaller: "Más pequeño",
    diffMoreItems: "Más elementos",
    diffFewerItems: "Menos elementos",
    keepLocal: "Conservar local",
    keepLocalDesc: "Sube tu versión local a la nube. La versión en la nube será reemplazada.",
    keepCloud: "Conservar en la nube",
    keepCloudDesc: "Descarga la versión de la nube a esta computadora. Tus archivos locales se sobrescribirán.",
    keepBoth: "Conservar ambos (Recomendado)",
    keepBothDesc: "Mantén activa la versión más reciente y conserva de forma segura la versión alternativa como copia archivada.",
    resolveLater: "Resolver más tarde",
    resolveLaterDesc: "La sincronización permanecerá pausada para este juego hasta que se resuelva.",
    resolvingConflict: "Resolviendo conflicto...",
    conflictResolvedSuccess: "Conflicto resuelto con éxito",

    toastSyncStarted: "Sincronización iniciada para {game}",
    toastSyncCompleted: "Sincronización completada con éxito para {game}",
    toastSyncFailed: "Error en la sincronización de {game}: {error}",
    toastSyncAllComplete: "Todos los juegos compatibles se sincronizaron con éxito",
    toastConflictDetected: "Conflicto detectado en {game} ({category})",
    toastConflictResolved: "Conflicto resuelto ({resolution})",
    toastSnapshotCreated: "Instantánea '{name}' creada con éxito",
    toastSnapshotRestored: "Instantánea '{name}' restaurada con éxito",
    toastSnapshotDeleted: "Instantánea eliminada con éxito",
    toastSnapshotPinned: "Instantánea fijada como guardado permanente",
    toastCustomPathSaved: "Rutas personalizadas actualizadas con éxito",
    toastCustomModPackaged: "Mod personalizado '{name}' empaquetado y sincronizado",
    toastNoChanges: "Todo está actualizado",
  },
  games: {
    title: "Juegos",
    subtitle:
    ...
    chessAiThinking: "La IA está pensando...",
    chessWhiteWins: "¡Jaque mate! Ganan las blancas.",
    chessBlackWins: "¡Jaque mate! Ganan las negras.",
    chessDrawStalemate: "Tablas por ahogado.",
    chessDrawRepetition: "Tablas por repetición.",
    ...
    chessReconnecting: "¡Oponente desconectado! Esperando {seconds}s...",
    chessOpponentDisconnected: "El oponente se desconectó y perdió por abandono.",
    chessResign: "Rendirse",
    chessResigned: "se rindió",
    chessResignConfirm: "¿Estás seguro de que quieres rendirte?",
    chessOfferDraw: "Ofrecer tablas",
    chessDrawOffered: "El oponente ofrece tablas. ¿Aceptar?",
    chessDrawDeclined: "Oferta de tablas rechazada.",
    chessRequestTakeback: "Pedir retroceso",
    chessTakebackRequested: "El oponente pide deshacer movimiento. ¿Aceptar?",
    chessTakebackDeclined: "Petición de retroceso rechazada.",
    chessRematch: "Revancha",
    chessRematchOffered: "El oponente ofrece la revancha. ¿Aceptar?",
    chessAccept: "Aceptar",
    ...
    chessTimeWhiteWins: "¡Tiempo agotado! Blancas ganan por tiempo.",
    chessTimeBlackWins: "¡Tiempo agotado! Negras ganan por tiempo.",
  ...
  support: {
    ...
    typePartnerRequest: "Solicitud de asociación",
  ...
  admin: {
    ...
    bannedIpsDesc:
      "Gestiona las prohibiciones de IP globales de Web Defender y sus motivos públicos.",
    ...
    partnersTitle: "Gestión de Socios",
    partnersSubtitle:
      "Administre socios activos y categorías de asociación mostradas en la página pública.",
    viewPublicPage: "Ver Página Pública",
    tabExisting: "Socios Existentes",
    tabWanted: "Categorías Buscadas",
    ...
    addFirstPartner: "Añadir Primer Socio",
    noExistingPartners: "Aún no se han añadido socios.",
    wantedPartnersTitle: "Categorías y Solicitudes de Socios Buscados",
    wantedPartnersDesc:
      "Defina oportunidades de asociación, lo que ofrece Oxygen Low's Software y lo que se solicita.",
    addWantedCategory: "Añadir Categoría",
    addFirstWanted: "Añadir Primera Oportunidad",
    noWantedPartners: "Aún no hay oportunidades de asociación definidas.",
    addPartnerTitle: "Añadir Nuevo Socio",
    editPartnerTitle: "Editar Socio",
    existingPartnerModalDesc:
      "Introduzca los datos de la empresa asociada para mostrar en la página pública.",
    partnerName: "Nombre de la Empresa",
    partnerCategory: "Categoría / Industria",
    partnerLogoUrl: "URL del Logotipo",
    partnerWebsiteUrl: "URL del Sitio Web",
    partnerDescription: "Descripción",
    partnerCreated: "Socio añadido correctamente",
    partnerUpdated: "Socio actualizado correctamente",
    deletePartnerConfirm: "¿Está seguro de que desea eliminar al socio \"{{name}}\"?",
    partnerDeleted: "Socio eliminado correctamente",
    addWantedTitle: "Añadir Oportunidad de Asociación",
    editWantedTitle: "Editar Oportunidad de Asociación",
    wantedModalDesc:
      "Defina la categoría, objetivos e intercambio de valor para socios potenciales.",
    wantedCategoryField: "Nombre de la Categoría",
    wantedTargetCompaniesField: "Empresas Objetivo / Ejemplo",
    wantedCreated: "Oportunidad añadida correctamente",
    wantedUpdated: "Oportunidad actualizada correctamente",
    deleteWantedConfirm: "¿Está seguro de que desea eliminar la categoría \"{{category}}\"?",
    wantedDeleted: "Oportunidad eliminada correctamente",
  },
  partners: {
    title: "Socios de Oxygen Low's Software",
    subtitle:
      "Explore socios existentes y oportunidades de colaboración con Oxygen Low's Software.",
    heroBadge: "Asociaciones y Colaboraciones",
    heroDesc:
      "Nos asociamos con empresas tecnológicas innovadoras, estudios de videojuegos y proveedores de infraestructura para ofrecer software de alta calidad y centrado en la privacidad.",
    ...
    goToSupportButton: "Solicitar Asociación (Soporte)",
    viewWantedButton: "Ver Oportunidades de Socios Buscados",
    wantedModalTitle: "Categorías y Oportunidades de Socios Buscados",
    wantedModalDesc:
      "Categorías y empresas con las que Oxygen Low's Software busca asociarse activamente, incluyendo ofertas mutuas.",
    noWantedYet: "No hay categorías de socios buscados en este momento.",
    targetCompanies: "Objetivo/Ejemplo",
    whatWeProvide: "Qué Ofrece Oxygen Low's Software",
    whatIsRequested: "Qué Se Solicita al Socio",
    notSpecified: "Opciones de integración flexibles.",
    interestedTitle: "¿Encaja en una de estas categorías o tiene una propuesta?",
    interestedDesc: "Póngase en contacto directamente con nuestro equipo de asociaciones.",
    ...
    noPartnersYetDesc:
      "Estamos revisando solicitudes y ampliando nuestra red de socios. ¡Contáctenos para colaborar!",
    applyNow: "Solicitar Asociación",
  ...
  security: {
    ...
    passkeysDesc:
      "Inicie sesión de forma segura utilizando la biometría de su dispositivo, Touch ID, Face ID, Windows Hello o llaves de seguridad de hardware.",
    registerPasskey: "Registrar una clave de acceso",
    registerPasskeyDesc:
      "Proporcione un nombre descriptivo y confirme su contraseña para registrar su clave de acceso biométrica o de hardware.",
    registerPasskeyBtn: "Añadir clave de acceso",
    passkeyNickname: "Nombre de la clave de acceso (opcional)",
    passkeyNicknamePlaceholder: "ej. MacBook Touch ID, YubiKey de trabajo",
    confirmPasswordToRegisterPasskey: "Contraseña de la cuenta (obligatoria)",
    confirmPasswordToDeletePasskey: "Confirmar contraseña de la cuenta",
    deletePasskey: "Eliminar clave de acceso",
    deletePasskeyConfirm:
      "¿Está seguro de que desea eliminar esta clave de acceso? Ingrese la contraseña de su cuenta para confirmar.",
    renamePasskey: "Renombrar clave de acceso",
    noPasskeys: "No hay claves de acceso registradas todavía",
    passkeyCreated: "Creada",
    passkeyLastUsed: "Último uso",
    passkeyRegisteredSuccess: "¡Clave de acceso registrada con éxito!",
    passkeyDeletedSuccess: "¡Clave de acceso eliminada con éxito!",
    passkeyRenamedSuccess: "¡Clave de acceso renombrada con éxito!",
  ...
  imageStudio: {
    ...
    templatesDesc: "Selecciona un diseño inicial para comenzar rápidamente tu proyecto gráfico.",
    useTemplate: "Usar plantilla",
    confirmLoadTemplate: "¿Cargar este diseño de plantilla? Se reemplazarán los cambios no guardados en el lienzo actual.",
    templateLoaded: "¡Plantilla cargada con éxito!",
    underline: "Subrayado",
    textEffects: "Efectos",
    typography: "Tipografía y efectos",
    ...
    prompt: "Indicación",
    promptPlaceholder: "Una ciudad ciberpunk futurista con carteles de neón brillantes y reflejos de lluvia...",
    styleModel: "Preajuste de estilo",
    promptRequired: "Por favor, introduce una indicación",
    generating: "Generando...",
    generate: "Generar e insertar",
    aiGenSuccess: "¡Imagen de IA creada e insertada en el lienzo!",
    aiGenFailed: "Error al generar la imagen. Por favor, inténtalo de nuevo.",
  },
  titles: {
    apps: "Aplicaciones",
    games: "Juegos",
    ...
    adminPartners: "Administración de Socios",
    ...
    adminBannedIps: "Admin — IPs prohibidas",
  ...
  adminBannedIps: {
    ...
    backToAdmin: "Volver al panel de administración",
    createTitle: "Prohibir una dirección IP",
    editTitle: "Editar IP prohibida",
    createDesc: "Se requiere un motivo que se mostrará en el directorio público de prohibiciones.",
    ipPlaceholder: "Dirección IPv4 o IPv6",
    reasonPlaceholder: "Motivo de esta prohibición",
    ...
    banUpdated: "Prohibición actualizada",
    ipBanned: "IP prohibida",
    banRevoked: "Prohibición revocada",
  ...
  bannedIpsPage: {
    ...
    searchPlaceholder: "Buscar dirección IP o motivo...",
    ...
    loading: "Cargando IPs prohibidas…",
    empty: "No hay IPs prohibidas activas que coincidan con la búsqueda.",
    bannedOn: "Prohibida",
    loadError: "No se pudieron cargar las IPs prohibidas",
  },
  threatLookup: {
    title: "Búsqueda de Inteligencia de Amenazas",
    subtitle: "Verifique cualquier dirección IP contra bloqueos activos de la plataforma, actores de amenazas conocidos, nodos de salida TOR y redes VPN.",
    inputPlaceholder: "Ingrese dirección IPv4 o IPv6 (ej., 1.1.1.1)",
  ...
  pixelArtStudio: {
    ...
    newCanvasTitle: "Nuevo lienzo de píxeles",
    presets: "Preajustes",
    width: "Ancho (px)",
    height: "Alto (px)",
    newCanvasWarning:
      "Crear un nuevo lienzo restablecerá el arte no guardado. Asegúrate de exportar o guardar tu proyecto actual.",
    create: "Crear lienzo",
    ...
    rescaleDesc: "Estirar o encoger píxeles existentes para ajustarse a las nuevas dimensiones.",
    applyResize: "Aplicar cambio de tamaño",
    pencil: "Lápiz",
    eraser: "Borrador",
    ...
    swatchTip: "Clic izquierdo: Primario • Clic derecho: Secundario",
    layers: "Capas",
    ...
    addFrame: "Añadir nuevo fotograma",
    ...
    scaleLabel: "Factor de escala de píxeles",
    pngDesc:
      "Exportar fotograma actual con escalado nítido y fondo transparente.",
    downloadPng: "Descargar PNG",
    copiedToClipboard: "¡Copiado al portapapeles!",
    clipboardNotSupported: "Copia al portapapeles no compatible",
    copyError: "Error al copiar imagen",
    pngExported: "¡PNG exportado con éxito!",
    ...
    columns: "Columnas de cuadrícula",
    downloadSheet: "Descargar hoja de sprites",
    sheetExported: "¡Hoja de sprites exportada con éxito!",
    gifDesc:
    ...
    gifExported: "¡GIF animado exportado con éxito!",
    projectDesc:
    ...
    projectDownloaded: "¡Archivo de proyecto descargado!",
    cloudSaveAvailable: "Almacenamiento en la nube conectado.",
    signInForCloud: "Inicia sesión para guardar directamente en Almacenamiento.",
    saveToStorage: "Guardar en Almacenamiento",
    savedToStorage: "¡Guardado en tu almacenamiento con éxito!",
    storageSaveError: "Error al guardar el archivo en el almacenamiento.",
    signInToSaveStorage: "Inicia sesión para guardar directamente en el almacenamiento.",
    paletteExtracted: "¡Colores extraídos del lienzo!",
    noColorsFound: "No se encontraron píxeles de color en el lienzo.",
    newCanvasCreated: "¡Nuevo lienzo creado!",
    canvasResized: "¡Lienzo redimensionado con éxito!",
    projectImported: "¡Proyecto importado con éxito!",
  ...
  developerAuth: {
    ...
    subtitle:
      "Aplicaciones OAuth 2.0, credenciales e integraciones de autenticación",
    createNewApp: "Crear Aplicación",
    noApps: "Aún no hay aplicaciones de autenticación",
    noAppsDesc:
      "Crea tu primera aplicación para obtener una clave API e integrar la autenticación de Oxygen Low's Software en tu sitio o app.",
    appName: "Nombre de la Aplicación",
    appNamePlaceholder: "ej. Mi Juego Personalizado",
    description: "Descripción",
    descriptionPlaceholder: "Describe brevemente tu aplicación",
    websiteUrl: "URL del Sitio Web",
    websiteUrlPlaceholder: "https://ejemplo.com",
    redirectUris: "URIs de Redirección (una por línea)",
    redirectUrisPlaceholder:
      "http://localhost:3000/api/auth/callback\nhttps://ejemplo.com/api/auth/callback",
    redirectUrisHelp:
      "Ingresa URIs de redirección completas. Se permiten http://localhost y http://127.0.0.1 para pruebas; las URLs de producción deben usar HTTPS.",
    ...
    scopeEmail: "Correo Electrónico",
    scopeEmailDesc: "Acceder a la dirección de correo electrónico verificada",
    scopeProfilePicture: "Foto de Perfil",
    scopeProfilePictureDesc: "Acceder a la URL del avatar del perfil",
    scopeBio: "Biografía",
    scopeBioDesc: "Acceder a la biografía pública del usuario",
    save: "Guardar Aplicación",
    cancel: "Cancelar",
    edit: "Editar",
    delete: "Eliminar",
    deleteConfirm:
      "¿Estás seguro de que deseas eliminar esta aplicación? Se revocarán todas las sesiones y tokens de usuario activos para esta app.",
    regenerateKey: "Regenerate API Key",
    regenerateKeyConfirm:
      "¿Estás seguro de que deseas regenerar tu clave API? La clave anterior dejará de funcionar inmediatamente.",
    keyGeneratedTitle: "Guarda tu Clave API Secreta",
    keyGeneratedDesc:
      "Esta clave API secreta solo se mostrará una vez. Guárdala de forma segura en las variables de entorno de tu servidor.",
    clientId: "ID de Cliente",
    apiKey: "Clave API",
    apiKeyPrefix: "Prefijo de Clave API",
    copied: "Copiado al portapapeles",
    copy: "Copiar",
    quickStart: "Inicio Rápido e Integración",
    envSnippet: "Variables de Entorno (.env)",
    sdkIntegration: "Integración de SDK (@oxygenlow/auth)",
    statsAuthorizedUsers: "Usuarios Autorizados",
    statsActiveTokens: "Tokens Activos",
    testingAuthUrl: "URL de Inicio de Sesión de Prueba",
    openTestLogin: "Abrir Pantalla de Inicio de Sesión",
    appCreated: "Aplicación creada exitosamente",
    appUpdated: "Aplicación actualizada exitosamente",
    appDeleted: "Aplicación eliminada exitosamente",
  ...
  oauthAuthorize: {
    ...
    by: "Creado por",
    requestedPermissions: "Esta aplicación recibirá acceso a:",
    allow: "Autorizar",
    deny: "Cancelar",
    loginRequired:
      "Inicia sesión en tu cuenta de Oxygen Low's Software para autorizar esta aplicación.",
    loginButton: "Iniciar Sesión / Registrarse",
    invalidRequest: "Solicitud de Autorización No Válida",
    redirecting: "Redirigiéndote de regreso a la aplicación...",
  },
  models: {
    title: "Modelos",
    ...
    noCustomModelsYet: "Aún no hay modelos personalizados registrados. Elige un ajuste o introduce un ID arriba.",
    apiKeyInputPlaceholder: "Ingresa la clave secreta de la API",
    apiKeyEncryptedSaved: "¡Clave API cifrada y guardada de forma segura!",
    apiKeyRemoved: "Clave API eliminada.",
    modelRegisteredSuccess: "¡Modelo personalizado registrado con éxito!",
    ...
    enterPasswordPrompt: "Introduce la contraseña de acceso al modelo",
    ...
    hostRelayConnected: "Relé Conectado",
    hostRelayDisconnected: "Relé Desconectado",
    masterPauseSharing: "Pausar Todo el Uso Compartido",
    resumeSharing: "Reanudar Uso Compartido",
    autoPauseGaming: "Pausa Automática al Jugar",
    autoPauseGamingDesc: "Pausa automáticamente el uso compartido cuando empiezas a jugar en tu escritorio.",
    ...
    scanning: "Escaneando...",
    noLocalModelsFound: "No se detectaron modelos locales. Asegúrate de que Ollama (11434), LM Studio (1234) o KoboldCPP (5001) estén ejecutándose.",
    customEndpoint: "Punto Final Compatible con OpenAI Personalizado",
    addCustomEndpoint: "Añadir Punto Final",
    ...
    accessModePublic: "Público (Todos)",
    accessModeFriends: "Solo Amigos",
    accessModePrivate: "Solo Mis Dispositivos",
    accessModePassword: "Protegido por Contraseña",
    modelPassword: "Contraseña del Modelo",
    maxConcurrentRequests: "Peticiones Simultáneas Máximas",
    maxOutputTokens: "Tokens de Salida Máximos",
    rateLimitRpm: "Límite de Tasa (Peticiones/Min)",
    dailyTokenCap: "Límite Diario de Tokens",
    liveActivityLog: "Registro de Actividad en Vivo",
    noActivityLogs: "Aún no se ha registrado actividad de inferencia.",
    playgroundTitle: "Zona de Pruebas de Modelos",
    playgroundPromptPlaceholder: "Escribe una instrucción o mensaje para probar este modelo...",
    send: "Enviar",
    generating: "Generando...",
  ...
  workspaces: {
    ...
    subtitle: "Espacios de proyectos colaborativos para compartir, escribir, editar y debatir archivos con miembros invitados.",
    joinWithCode: "Unirse con Código",
    newWorkspace: "Nuevo Espacio de Trabajo",
    searchWorkspaces: "Buscar espacios de trabajo...",
    loading: "Cargando espacios de trabajo...",
    noMatchingWorkspaces: "No se encontraron espacios de trabajo que coincidan con tu búsqueda.",
    noWorkspacesYet: "Aún no te has unido a ningún espacio de trabajo.",
    emptyDescription: "Crea un espacio de trabajo o únete a uno existente usando un código de invitación o enlace de un colaborador.",
    createFirstWorkspace: "Crear Espacio de Trabajo",
    createWorkspace: "Crear Nuevo Espacio de Trabajo",
    createWorkspaceDesc: "Crea un espacio colaborativo para que tu equipo comparta archivos de almacenamiento, edite código y discuta tareas.",
    workspaceNameLabel: "Nombre del Espacio de Trabajo *",
    workspaceDescLabel: "Descripción (opcional)",
    createButton: "Crear",
    joinTitle: "Unirse al Espacio de Trabajo",
    joinDesc: "Introduce el código o token de invitación compartido por el propietario del espacio.",
    inviteCodeLabel: "Código de Invitación",
    joinButton: "Unirse",
    owner: "Propietario",
    collaborator: "Colaborador",
    backToWorkspaces: "Volver a Espacios de Trabajo",
    copied: "¡Copiado!",
    copyInviteLink: "Enlace de Invitación",
    members: "Miembros",
    deleteWorkspace: "Eliminar Espacio de Trabajo",
    leaveWorkspace: "Salir",
    filesTab: "Archivos del Proyecto",
    discussionTab: "Discusión y Actividad del Equipo",
    searchFiles: "Buscar archivos del proyecto...",
    addFiles: "Añadir Archivos",
    loadingFiles: "Cargando archivos...",
    noMatchingFiles: "No hay archivos que coincidan con tu búsqueda",
    noFilesYet: "Aún no hay archivos en este espacio de trabajo",
    addFilesPrompt: "Importa archivos de tu almacenamiento personal o sube nuevos recursos para colaborar con tu equipo.",
    fileName: "Nombre",
    fileSize: "Tamaño",
    updated: "Actualizado",
    author: "Por",
    ...
    discussionBoard: "Discusión del Equipo",
    messages: "mensajes",
    noDiscussionYet: "Aún no hay mensajes. ¡Inicia la conversación con tu equipo!",
    typeDiscussion: "Comparte una actualización o comentario...",
    activityFeed: "Actividad del Proyecto",
    noActivities: "No hay actividades recientes del proyecto",
    addFilesToProject: "Añadir Archivos al Proyecto",
    addFilesDesc: "Importa archivos copiados de tu almacenamiento personal cifrado o súbelos directamente desde tu dispositivo.",
    importFromStorage: "Importar de Mi Almacenamiento",
    uploadFromDevice: "Subir desde Dispositivo",
    loadingStorage: "Cargando tus archivos personales...",
    noPersonalFiles: "No se encontraron archivos de almacenamiento personal.",
    filesSelected: "archivo(s) seleccionado(s)",
    copyIntoWorkspace: "Copiar al Espacio de Trabajo",
    uploadingFiles: "Subiendo archivos...",
    dropFilesPrompt: "Haz clic para seleccionar archivos del dispositivo",
    uploadQuotaNote: "Cuenta contra la cuota del propietario del espacio",
    edit: "Editar",
    preview: "Vista previa",
    save: "Guardar",
    loadingEditor: "Cargando contenido del archivo...",
    editorPlaceholder: "Introduce el contenido del archivo aquí...",
    conflictTitle: "Conflicto de Edición Detectado",
    conflictDesc: "Otro colaborador guardó cambios en este archivo mientras lo editabas. ¿Deseas sobrescribir sus cambios o descartar tus ediciones no guardadas?",
    reloadLatest: "Recargar Último",
    overwriteAnyway: "Sobrescribir de Todos Modos",
    commentsFor: "Comentarios para",
    noFileCommentsYet: "Aún no hay comentarios en este archivo. Deja comentarios para los colaboradores.",
    addFileComment: "Escribe un comentario...",
    projectMembers: "Miembros del Proyecto",
    membersDesc: "Los colaboradores pueden ver, modificar y debatir archivos del proyecto.",
    remove: "Eliminar",
    regenerateInvite: "Restablecer Código de Invitación",
    confirmDeleteTitle: "¿Eliminar Espacio de Trabajo?",
    confirmDeleteDesc: "Esto eliminará permanentemente todos los archivos, comentarios y miembros dentro de este espacio de trabajo. Esta acción no se puede deshacer.",
    confirmLeaveTitle: "¿Salir del Espacio de Trabajo?",
    confirmLeaveDesc: "Perderás el acceso a los archivos y discusiones de este espacio a menos que seas re-invitado.",
    leave: "Salir",
    errorLoading: "Error al cargar los datos del espacio de trabajo",
    alreadyMemberToast: "Se abrió tu espacio de trabajo",
    joinSuccessToast: "¡Te has unido con éxito al espacio de trabajo!",
    createdSuccess: "¡Espacio de trabajo creado con éxito!",
    inviteCopied: "¡Enlace de invitación copiado al portapapeles!",
    inviteRegenerated: "¡Nuevo código de invitación generado!",
    deletedSuccess: "Espacio de trabajo eliminado.",
    leftSuccess: "Saliste del espacio de trabajo.",
    memberRemoved: "Miembro eliminado del espacio de trabajo.",
    importedCount: "Se importaron {count} archivo(s) al espacio de trabajo.",
    fileSaved: "¡Archivo guardado con éxito!",
    fileDeleted: "Archivo eliminado del espacio de trabajo.",
  ...
  browserApp: {
    ...
    homeSearchPlaceholder: "Buscar sitios web o ingresar URL (ej. oxygenlow.com)...",
    search: "Buscar",
    readerMode: "Modo lectura",
    liveMode: "Vista web en vivo",
    ...
    searching: "Buscando en el índice...",
    searchResultsFor: "Resultados de búsqueda para",
    indexedPagesFound: "Se encontraron {count} páginas indexadas",
    noResultsFound: "No se encontraron páginas indexadas para esta búsqueda.",
    noResultsTip: "Prueba con otra palabra clave o introduce una dirección web directa.",
    directNavigate: "Navegar directamente a",
    webSearchExternal: "Buscar en la web externa",
    quickAccess: "Acceso rápido",
    noBookmarks: "Aún no hay marcadores guardados. Haz clic en el icono de marcador en la barra de direcciones para guardar páginas.",
    noHistory: "El historial de navegación está vacío.",
    clearHistory: "Borrar historial",
    historyCleared: "Historial de navegación borrado",
    savedBookmarks: "Marcadores guardados",
    browsingHistory: "Historial de navegación",
    removedFromBookmarks: "Eliminado de marcadores",
    addedToBookmarks: "Añadido a marcadores",
    failedReader: "No se pudo extraer la vista de lectura para esta página",
    failedSearch: "Error al obtener resultados de búsqueda",
  },
} as const;
