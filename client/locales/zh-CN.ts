export const zhCN = {
  ...
  storage: {
    ...
    filesTab: "文件",
    submissionsTab: "审核申请",
    verifyForMultiplayer: "验证用于多人游戏",
    verifiedBadge: "多人游戏已验证",
  ...
  verification: {
    ...
    verifyForMultiplayer: "验证用于多人游戏",
    verifyForMultiplayerTitle: "多人游戏使用验证",
    verifyForMultiplayerDesc: "提交此私有资产进行验证，以便在多人游戏中使用，无需公开发布。",
    publishToPublicAssets: "发布到公开资产",
    verifiedForPublicUsageBadge: "已验证公开使用",
    verifiedForMultiplayerBadge: "多人游戏已验证",
    publicBadge: "公开资产",
