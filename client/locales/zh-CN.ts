export const zhCN = {
  ...
  apps: {
    ...
    digitalFootprintTitle: "数字足迹",
    digitalFootprintDesc:
      "审计公开暴露面，扫描泄露的凭据，并在本地清理社交媒体历史记录。",
  },
  games: {
    title: "游戏",
  ...
  digitalFootprint: {
    title: "数字足迹",
    subtitle:
      "审计您的公开数字足迹，在数据泄露数据库中检查暴露的凭据，并清理社交媒体历史记录，且不会向服务器发送任何数据。",
    tabScanner: "扫描器",
    tabRedact: "社交媒体擦除",
    tabOptOut: "退出收集指南",
    enterAtLeastOne: "请至少输入一个要扫描的标识符。",
    scanCompleted: "数字足迹扫描成功完成！",
    exportAudit: "导出审计报告",
    reportExported: "审计报告已导出为 JSON。",
    inputDetails: "目标标识符",
    inputDescription: "提供要在本地扫描的用户名、电子邮件或凭据。",
    username: "用户名 / 账号",
    email: "电子邮箱",
    phone: "电话号码",
    passwordCheck: "密码（k-匿名性泄露检查）",
    kAnonymityNote:
      "使用 SHA-1 进行哈希处理。仅查询前 5 位十六进制字符；密码绝不会离开您的浏览器。",
    realName: "真实姓名 / 别名",
    startScan: "运行足迹扫描",
    scanning: "扫描中...",
    readyToScan: "准备扫描数字足迹",
    readyDescription:
      "在左侧输入用户名、电子邮件、电话号码或密码，以发现公开账户、数据泄露记录和数据经纪商风险。",
    loadSample: "加载示例测试查询",
    runningScan: "正在执行深度情报搜集...",
    queryingLocal:
      "正在查询 30 多个服务接入点、k-匿名性泄露数据库和经纪商目录。",
    privacyScore: "隐私评分",
    risk: "风险等级",
    publicProfiles: "已映射终端节点",
    acrossServices: "跨社交和开发者服务",
    breachesDetected: "检测到的泄露事件",
    historicalExposures: "匹配到的历史数据泄露目录",
    threatAlerts: "安全与隐私警报",
    recommendation: "建议操作",
    mappedAccounts: "公开平台足迹",
    mappedAccountsDesc:
      "映射到此账号的直接个人资料 URL。请验证并清理不必要的账户。",
    matchedBreaches: "已知的历史数据泄露",
    desktopExclusiveNotice: "桌面版专属功能",
    desktopExclusiveDesc:
      "直接跨域批量删除需要 Oxygen Low 桌面应用程序，以绕过浏览器 CORS 安全限制，同时确保零服务器传输。您可以在下方以模拟模式预览、筛选和导出数据。",
    selectPlatform: "选择平台",
    sessionAuth: "会话认证与内容加载",
    sessionAuthDesc: "凭据严格保留在本地内存中，绝不上传。",
    sessionTokenOrCookie: "会话令牌 / API 密钥 / 认证 Cookie",
    loadAccountData: "获取并列出账户内容",
    disconnect: "断开连接",
    demoSessionLoaded: "已在本地模式下加载会话。",
    platformConnected: "已在本地连接经过身份验证的会话。",
    filterOptions: "擦除筛选器",
    matchingItems: "个匹配项",
    keyword: "关键词 / 搜索",
    startDate: "起始日期",
    endDate: "截止日期",
    throttleDelay: "请求延迟（速率限制保护）",
    selectAll: "选择所有可见项",
    downloadArchive: "导出备份 JSON",
    massDelete: "批量删除选中项",
    deletingItems: "正在擦除项目...",
    deletionFinished: "删除已完成",
    noItemsMatch: "未找到符合当前筛选条件的项目。",
    noItemsSelected: "未选择任何项目。",
    backupExported: "备份存档导出成功！",
    massDeleteComplete: "项目擦除成功！",
    dataBrokerDirectory: "数据经纪商退出收集目录",
    dataBrokerDirectoryDesc:
      "主要商业个人信息搜索经纪商的退出申请表直接链接。",
    optOutLink: "提交退出申请",
    privacyHardening: "隐私加固清单",
    privacyHardeningDesc:
      "您今天即可采取的切实可行的措施，以最大限度地减少数字足迹。",
    confirmDeleteTitle: "确认批量内容删除",
    confirmDeleteDesc: "您即将永久删除选定项目，来源平台：",
    cannotBeUndone:
      "此操作在客户端执行且无法撤销。建议首先下载备份存档。",
    wipeNow: "继续批量擦除",
  },
  titles: {
    apps: "应用",
