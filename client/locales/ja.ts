export const ja = {
  ...
  apps: {
    ...
    webDefenderDesc: "DDoS攻撃、インジェクション攻撃、ボット、および悪意のあるトラフィックからウェブサイトやAPIを保護します。",
  },
  games: {
    title: "ゲーム",
  ...
  oauthConsent: {
    title: "アプリケーションを承認",
    subtitle: "があなたの Oxygen Low アカウントへのアクセスを求めています",
  ...
  security: {
    ...
    chatbotChats: "チャットボットの会話とAIプロバイダーキー",
    chatbotChatsDesc: "AI会話、ユーザープロンプト、システムプロンプト、履歴メッセージ、カスタムAIプロバイダーAPIキーを暗号化します。",
    ...
    architectureTitle: "ゼロ知識＆プライバシーアーキテクチャ",
    arch1Title: "クライアント側 AES-256 暗号化",
    arch1Desc: "すべての暗号化はデータを送信または保存する前にブラウザ内で直接実行されます。サーバーやデータベース管理者も内容を読むことはできません。",
    arch2Title: "カスタム AI プロバイダー API キー",
    arch2Desc: "今後追加されるカスタムAIプロバイダーキー（OpenAI、Anthropic、OpenRouterなど）と会話履歴がマスターキーで暗号化され、認証情報が安全に保護されます。",
    arch3Title: "マスターキーのバックアップ",
    arch3Desc: "Oxygen Lowはゼロ知識暗号化を採用しているため、マスターキーを紛失するとデータを復元できません。信頼できるパスワードマネージャーに保管してください。",
  },
} as const;
