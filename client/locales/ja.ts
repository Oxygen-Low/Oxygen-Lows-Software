export const ja = {
  ...
  apps: {
    ...
    digitalFootprintTitle: "デジタルフットプリント",
    digitalFootprintDesc:
      "公開露出を監査し、漏洩した認証情報をスキャンし、ソーシャルメディアの履歴をローカルで消去します。",
  },
  games: {
    title: "ゲーム",
    subtitle:
  ...
  digitalFootprint: {
    title: "デジタルフットプリント",
    subtitle:
      "公開デジタルフットプリントを監査し、データ漏洩データベースで露出した認証情報をチェックし、サーバーにデータを送信することなくソーシャルメディアの履歴を消去します。",
    tabScanner: "スキャナー",
    tabRedact: "ソーシャル消去",
    tabOptOut: "オプトアウトガイド",
    enterAtLeastOne: "スキャンする識別子を少なくとも1つ入力してください。",
    scanCompleted: "フットプリントスキャンが正常に完了しました！",
    exportAudit: "監査結果をエクスポート",
    reportExported: "監査レポートがJSONとしてエクスポートされました。",
    inputDetails: "対象の識別子",
    inputDescription:
      "ローカルでスキャンするユーザー名、メール、または認証情報を入力してください。",
    username: "ユーザー名 / ハンドル",
    email: "メールアドレス",
    phone: "電話番号",
    passwordCheck: "パスワード (k-Anonymity漏洩チェック)",
    kAnonymityNote:
      "SHA-1でハッシュ化されます。先頭5文字の16進数のみを照会し、パスワードがブラウザから送信されることはありません。",
    realName: "本名 / エイリアス",
    startScan: "フットプリントスキャンを実行",
    scanning: "スキャン中...",
    readyToScan: "デジタルフットプリントをスキャンする準備ができました",
    readyDescription:
      "左側にユーザー名、メール、電話番号、またはパスワードを入力して、公開アカウント、漏洩履歴、データブローカーの露出を検出します。",
    loadSample: "サンプルクエリを読み込む",
    runningScan: "詳細な偵察を実行中...",
    queryingLocal:
      "30以上のサービスエンドポイント、k-anonymity漏洩DB、ブローカーディレクトリを照会中。",
    privacyScore: "プライバシースコア",
    risk: "リスク",
    publicProfiles: "検出されたエンドポイント",
    acrossServices: "ソーシャルおよび開発者サービス全体",
    breachesDetected: "検出された漏洩",
    historicalExposures: "一致した過去のデータ漏洩カタログ",
    threatAlerts: "セキュリティとプライバシーのアラート",
    recommendation: "推奨アクション",
    mappedAccounts: "公開プラットフォームフットプリント",
    mappedAccountsDesc:
      "このハンドルにマッピングされた直接プロフィールURL。不要なアカウントを確認して消去してください。",
    matchedBreaches: "一致した過去のデータ侵害",
    desktopExclusiveNotice: "デスクトップ専用機能",
    desktopExclusiveDesc:
      "直接の一括削除には、ブラウザのCORS制限を回避しつつサーバー送信ゼロを保証するOxygen Lowデスクトップアプリが必要です。以下でシミュレーションモードとしてプレビュー、フィルター、エクスポートが可能です。",
    selectPlatform: "プラットフォームを選択",
    sessionAuth: "セッション認証とコンテンツ取得",
    sessionAuthDesc:
      "認証情報はローカルメモリ内でのみ保持され、アップロードされることはありません。",
    sessionTokenOrCookie: "セッショントークン / APIキー / 認証Cookie",
    loadAccountData: "アカウントコンテンツを取得して一覧表示",
    disconnect: "切断",
    demoSessionLoaded: "ローカルモードでセッションが読み込まれました。",
    platformConnected: "認証済みセッションがローカルで接続されました。",
    filterOptions: "消去フィルター",
    matchingItems: "件の一致項目",
    keyword: "キーワード / 検索",
    startDate: "開始日",
    endDate: "終了日",
    throttleDelay: "リクエスト遅延 (レート制限対策)",
    selectAll: "表示中のすべてを選択",
    downloadArchive: "バックアップJSONをエクスポート",
    massDelete: "選択した項目を一括削除",
    deletingItems: "項目を消去中...",
    deletionFinished: "消去が完了しました",
    noItemsMatch: "現在のフィルターに一致する項目は見つかりませんでした。",
    noItemsSelected: "項目が選択されていません。",
    backupExported: "バックアップアーカイブが正常にエクスポートされました！",
    massDeleteComplete: "項目の消去が正常に完了しました！",
    dataBrokerDirectory: "データブローカーオプトアウトディレクトリ",
    dataBrokerDirectoryDesc:
      "主要な商用個人情報ブローカーのオプトアウトフォームへの直接リンク。",
    optOutLink: "オプトアウトを送信",
    privacyHardening: "プライバシー強化チェックリスト",
    privacyHardeningDesc:
      "デジタルフットプリントを最小限に抑えるために今すぐできる実践的な対策。",
    confirmDeleteTitle: "一括コンテンツ削除の確認",
    confirmDeleteDesc:
      "選択した項目を以下から完全に削除しようとしています:",
    cannotBeUndone:
      "この操作はクライアント側で実行され、元に戻すことはできません。最初にバックアップアーカイブをダウンロードすることをお勧めします。",
    wipeNow: "一括消去を実行",
  },
  titles: {
    apps: "アプリ",
