export const ja = {
  ...
  storage: {
    ...
    filesTab: "ファイル",
    submissionsTab: "検証申請",
    verifyForMultiplayer: "マルチプレイヤー用に検証",
    verifiedBadge: "マルチプレイヤー検証済み",
  ...
  verification: {
    ...
    verifyForMultiplayer: "マルチプレイヤー用に検証",
    verifyForMultiplayerTitle: "マルチプレイヤー利用の検証",
    verifyForMultiplayerDesc: "公開することなく、マルチプレイヤーゲームで使用するためにこのプライベートアセットを検証に提出します。",
    publishToPublicAssets: "パブリックアセットに公開",
    verifiedForPublicUsageBadge: "パブリック利用検証済み",
    verifiedForMultiplayerBadge: "マルチプレイヤー検証済み",
