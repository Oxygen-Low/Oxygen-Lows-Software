export const ko = {
  ...
  apps: {
    ...
    digitalFootprintTitle: "디지털 발자국",
    digitalFootprintDesc:
      "공개 노출을 감사하고 유출된 자격 증명을 스캔하며 소셜 미디어 기록을 로컬에서 정리합니다.",
  },
  games: {
    title: "게임",
  ...
  digitalFootprint: {
    title: "디지털 발자국",
    subtitle:
      "공개 디지털 발자국을 감사하고, 유출 데이터베이스에서 노출된 자격 증명을 확인하며, 서버로 데이터를 전송하지 않고 소셜 미디어 기록을 정리합니다.",
    tabScanner: "스캐너",
    tabRedact: "소셜 기록 정리",
    tabOptOut: "정보 삭제 안내",
    enterAtLeastOne: "스캔할 식별자를 하나 이상 입력하세요.",
    scanCompleted: "디지털 발자국 스캔이 완료되었습니다!",
    exportAudit: "감사 결과 내보내기",
    reportExported: "감사 보고서가 JSON으로 내보내졌습니다.",
    inputDetails: "대상 식별자",
    inputDescription:
      "로컬에서 스캔할 사용자 이름, 이메일 또는 자격 증명을 입력하세요.",
    username: "사용자 이름 / 핸들",
    email: "이메일 주소",
    phone: "전화번호",
    passwordCheck: "비밀번호 (k-익명성 유출 검사)",
    kAnonymityNote:
      "SHA-1로 해시됩니다. 앞 5자리 16진수만 조회되며 비밀번호는 브라우저 외부로 전송되지 않습니다.",
    realName: "실명 / 별칭",
    startScan: "발자국 스캔 실행",
    scanning: "스캔 중...",
    readyToScan: "디지털 발자국 스캔 준비 완료",
    readyDescription:
      "왼쪽에 사용자 이름, 이메일, 전화번호 또는 비밀번호를 입력하여 공개 계정, 유출 기록 및 데이터 브로커 노출을 검색하세요.",
    loadSample: "샘플 쿼리 불러오기",
    runningScan: "심층 정찰 수행 중...",
    queryingLocal:
      "30개 이상의 서비스 엔드포인트, k-익명성 유출 DB, 데이터 브로커 디렉토리를 쿼리하는 중입니다.",
    privacyScore: "개인정보 보호 점수",
    risk: "위험도",
    publicProfiles: "매핑된 엔드포인트",
    acrossServices: "소셜 및 개발자 서비스 전반",
    breachesDetected: "감지된 유출",
    historicalExposures: "일치하는 과거 데이터 유출 카탈로그",
    threatAlerts: "보안 및 개인정보 보호 경보",
    recommendation: "권장 조치",
    mappedAccounts: "공개 플랫폼 발자국",
    mappedAccountsDesc:
      "이 핸들에 매핑된 프로필 URL입니다. 불필요한 계정을 확인하고 삭제하세요.",
    matchedBreaches: "일치된 과거 데이터 유출",
    desktopExclusiveNotice: "데스크톱 전용 기능",
    desktopExclusiveDesc:
      "직접 대량 삭제는 서버 전송 없이 브라우저 CORS 제한을 우회하기 위해 Oxygen Low 데스크톱 앱이 필요합니다. 아래에서 시뮬레이션 모드로 미리보기, 필터링 및 내보내기를 할 수 있습니다.",
    selectPlatform: "플랫폼 선택",
    sessionAuth: "세션 인증 및 콘텐츠 로더",
    sessionAuthDesc:
      "자격 증명은 로컬 메모리에만 엄격히 유지되며 절대 업로드되지 않습니다.",
    sessionTokenOrCookie: "세션 토큰 / API 키 / 인증 쿠키",
    loadAccountData: "계정 콘텐츠 가져오기 및 목록 표시",
    disconnect: "연결 해제",
    demoSessionLoaded: "로컬 모드로 세션이 로드되었습니다.",
    platformConnected: "인증된 세션이 로컬에 연결되었습니다.",
    filterOptions: "정리 필터",
    matchingItems: "개의 일치 항목",
    keyword: "키워드 / 검색",
    startDate: "시작일",
    endDate: "종료일",
    throttleDelay: "요청 지연 (속도 제한)",
    selectAll: "표시된 모든 항목 선택",
    downloadArchive: "백업 JSON 내보내기",
    massDelete: "선택한 항목 대량 삭제",
    deletingItems: "항목 삭제 중...",
    deletionFinished: "삭제 완료",
    noItemsMatch: "현재 필터와 일치하는 항목이 없습니다.",
    noItemsSelected: "선택된 항목이 없습니다.",
    backupExported: "백업 아카이브를 성공적으로 내보냈습니다!",
    massDeleteComplete: "항목이 성공적으로 삭제되었습니다!",
    dataBrokerDirectory: "데이터 브로커 정보 삭제 디렉토리",
    dataBrokerDirectoryDesc:
      "주요 상업용 인물 검색 브로커의 정보 삭제 양식 바로가기 링크.",
    optOutLink: "삭제 요청 제출",
    privacyHardening: "개인정보 보호 강화 체크리스트",
    privacyHardeningDesc:
      "디지털 발자국을 최소화하기 위해 지금 바로 취할 수 있는 실천 조치.",
    confirmDeleteTitle: "대량 콘텐츠 삭제 확인",
    confirmDeleteDesc:
      "다음 플랫폼에서 선택한 항목을 영구적으로 삭제하려고 합니다:",
    cannotBeUndone:
      "이 작업은 클라이언트 측에서 수행되며 취소할 수 없습니다. 먼저 백업 아카이브를 다운로드하는 것을 권장합니다.",
    wipeNow: "대량 삭제 진행",
  },
  titles: {
    apps: "앱",
