export const ko = {
  ...
  storage: {
    ...
    verifyForMultiplayer: "멀티플레이어용 검증",
    verifiedBadge: "멀티플레이어 검증 완료",
  ...
  verification: {
    ...
    verifyForMultiplayer: "멀티플레이어용 검증",
    verifyForMultiplayerTitle: "멀티플레이어 사용 검증",
    verifyForMultiplayerDesc: "공개하지 않고 멀티플레이어 게임에서 사용할 수 있도록 이 비공개 에셋의 검증을 요청합니다.",
    publishToPublicAssets: "공개 에셋에 게시",
    verifiedForPublicUsageBadge: "공개 사용 검증 완료",
    verifiedForMultiplayerBadge: "멀티플레이어 검증 완료",
    publicBadge: "공개 에셋",
