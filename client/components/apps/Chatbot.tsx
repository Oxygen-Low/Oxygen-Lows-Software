      ...
      while (true) {
        ...
        for (const line of lines) {
          ...
          try {
            ...
            if (selectedProvider === "openai" || selectedProvider === "openrouter" || selectedProvider === "grok" || selectedProvider === "custom" || selectedProvider === "stablehorde" || selectedProvider === "lmstudio" || selectedProvider === "koboldcpp" || selectedProvider === "kobold") {
