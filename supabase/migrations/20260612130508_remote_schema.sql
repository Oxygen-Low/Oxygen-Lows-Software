alter table "public"."user_preferences" add column "last_model_id" text;

alter table "public"."user_preferences" add column "last_provider" text;
...
BEGIN
  ...
  ON CONFLICT (user_id) DO UPDATE SET
    ...
    last_model_id = COALESCE(p_last_model_id, user_preferences.last_model_id),
    last_provider = COALESCE(p_last_provider, user_preferences.last_provider),
    updated_at = NOW()
