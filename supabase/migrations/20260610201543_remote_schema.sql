drop trigger if exists "trg_chat_character_owner" on "public"."chats";

drop function if exists "public"."fn_check_chat_character_owner"();

drop index if exists "public"."idx_characters_user_id";

alter table "public"."characters" drop column "image_path";
