-- Restore encryption support (re-applying 20260618000002 after accidental removal in remote_schema)

-- Add is_encrypted column to characters, chats, and chat_messages
ALTER TABLE public.characters ADD COLUMN IF NOT EXISTS is_encrypted BOOLEAN DEFAULT FALSE;
...
-- Add encryption_settings to user_preferences
