...
CREATE UNIQUE INDEX user_models_pkey ON public.user_models USING btree (id);

CREATE UNIQUE INDEX user_models_user_id_provider_model_id_key ON public.user_models USING btree (user_id, provider, model_id);
...
alter table "public"."user_models" add constraint "user_models_pkey" PRIMARY KEY using index "user_models_pkey";
...
alter table "public"."chat_messages" add constraint "chat_messages_role_check" CHECK ((role = ANY (ARRAY['system'::text, 'user'::text, 'assistant'::text]))) not valid;
...
alter table "public"."user_models" add constraint "user_models_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE not valid;

alter table "public"."user_models" validate constraint "user_models_user_id_fkey";

alter table "public"."user_models" add constraint "user_models_user_id_provider_model_id_key" UNIQUE using index "user_models_user_id_provider_model_id_key";
...
grant delete on table "public"."user_models" to "anon";

grant insert on table "public"."user_models" to "anon";

grant references on table "public"."user_models" to "anon";

grant select on table "public"."user_models" to "anon";

grant trigger on table "public"."user_models" to "anon";

grant truncate on table "public"."user_models" to "anon";

grant update on table "public"."user_models" to "anon";

grant delete on table "public"."user_models" to "authenticated";

grant insert on table "public"."user_models" to "authenticated";

grant references on table "public"."user_models" to "authenticated";

grant select on table "public"."user_models" to "authenticated";

grant trigger on table "public"."user_models" to "authenticated";

grant truncate on table "public"."user_models" to "authenticated";

grant update on table "public"."user_models" to "authenticated";

grant delete on table "public"."user_models" to "service_role";

grant insert on table "public"."user_models" to "service_role";

grant references on table "public"."user_models" to "service_role";

grant select on table "public"."user_models" to "service_role";

grant trigger on table "public"."user_models" to "service_role";

grant truncate on table "public"."user_models" to "service_role";

grant update on table "public"."user_models" to "service_role";


  create policy "Users can manage messages of their own chats"
