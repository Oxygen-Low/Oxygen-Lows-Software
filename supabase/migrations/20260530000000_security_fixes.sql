-- Fix search_path and revoke execute for public.check_image_links_limit
...
REVOKE EXECUTE ON FUNCTION public.check_image_links_limit() FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.check_image_links_limit() FROM anon, authenticated;

-- Fix search_path and revoke execute for public.check_user_total_storage_limit
...
-- Fix search_path and revoke execute for public.block_automatic_linking
...
REVOKE EXECUTE ON FUNCTION public.block_automatic_linking() FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.block_automatic_linking() FROM anon, authenticated;
